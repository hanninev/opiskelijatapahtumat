    ...
    render() {
        ...
        const locationFilter = (listToFilter) => {
            const filteredList = listToFilter.filter(e => {
                return e.locations.some(l => locations.includes(l._id))
            })
            return filteredList
        }
        ...
        const organizerFilter = (listToFilter) => {
            const filteredList = listToFilter.filter(e => {
                return e.organizers.some(o => organizers.includes(o._id))
            })
            return filteredList
        }
        ...
        const organizerTypeFilter = (listToFilter) => {
            const filteredList = listToFilter.filter(e => {
                return e.organizers.some(o => organizerTypes.includes(o.organizer_type))
            })
            return filteredList
        }
        ...
        const eventTypeFilter = (listToFilter) => {
            const filteredList = listToFilter.filter(e => {
                return e.eventTypes.some(et => eventTypes.includes(et._id))
            })
            return filteredList
        }
